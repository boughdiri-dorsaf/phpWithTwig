...
class ReservationController {
    ...
    public function grilleTarifaireHotel($entree, $sortie){
        ...
        while (($date_sejour < $sortie))
            {
                ...
                $lpd[1] = 0;	$dp[1] = 0; $pc[1] = 0;	$allinsoft[1] = 0;	$allin[1] = 0;  $ultraallin[1] = 0;
                // 2 chambre single : 1 enfant ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[2] = 0;  $dp[2] = 0; $pc[2] = 0;	$allinsoft[2] = 0; $allin[2] = 0;	$ultraallin[2] = 0;
                // 3 Chambre double : 2 ad ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[3] = 0;	$dp[3] = 0;	$pc[3] = 0;	$allinsoft[3] = 0;	$allin[3] = 0;	$ultraallin[3]= 0;
                // 4 chmabre double : 1ad + 1enf ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[4] = 0;	$dp[4] = 0;	$pc[4] = 0;	$allinsoft[4] = 0; $allin[4] = 0;	$ultraallin[4] = 0;
                // 5 chambre double : 2 enf ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[5] = 0;		$dp[5] = 0;	$pc[5] = 0;	$allinsoft[5] = 0;	$allin[5]= 0;	$ultraallin[5] = 0;
                // 6 Chambre triple : 3 adulte ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[6] = 0; $dp[6] = 0;	$pc[6] = 0;	$allinsoft[6] = 0;  $allin[6] = 0;  $ultraallin[6] = 0;
                // 7 chambre triple : 2 ad + 1 enf ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[7] = 0;	$dp[7] = 0;	$pc[7] = 0;	$allinsoft[7] = 0;	$allin[7] = 0;	$ultraallin[7] = 0;
                // 8 chambre triple : 1 ad + 2 enf ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[8] = 0;	$dp[8] = 0;	$pc[8] = 0;	$allinsoft[8] = 0;	$allin[8] = 0;	$ultraallin[8] = 0;
                // 9 chambre triple : 3 enf ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[9] = 0;	$dp[9] = 0;	$pc[9] = 0;	$allinsoft[9] = 0;	$allin[9] = 0;	$ultraallin[9] = 0;
                // 10 chambre quad : 4 ad ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[10] = 0;		$dp[10] = 0;	$pc[10] = 0;	$allinsoft[10] = 0;	$allin[10] = 0;	$ultraallin[10] = 0;
                // 11 chambre quad : 3 ad + 1 enf ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[11] = 0;	$dp[11] = 0;	$pc[11] = 0;	$allinsoft[11] = 0;	$allin[11] = 0;	$ultraallin[11] = 0;
                // 12 chambre quad : 2 ad + 2 enf ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[12] = 0;	$dp[12] = 0;	$pc[12] = 0;	$allinsoft[12] = 0;	$allin[12] = 0;	$ultraallin[12] = 0;
                // 13 chambre quad : 1 ad + 3 enf ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[13] = 0;	$dp[13] = 0;	$pc[13] = 0;	$allinsoft[13] = 0;	$allin[13] = 0;	$ultraallin[13] = 0;
                // 14 chambre quad : 0 ad + 4 enf ( lpd / DP / PC / Allinsoft / allin / ultraallin )
                $lpd[14] = 0;	$dp[14] = 0;	$pc[14] = 0;	$allinsoft[14] = 0;	$allin[14] = 0;	$ultraallin[14] = 0;

                
                $donnees = $this->db->query("SELECT * from saison_hotel WHERE '".$date_sejour."' BETWEEN date_debut and date_fin");
    ...
    public function reservation(){
        ...
        while ($date_sejour < $sortie)
        {
                ...
                $requete = $this->db->query("SELECT * from saison_hotel WHERE id_hotel = '".$hotel."' and'".$date_sejour."' BETWEEN date_debut and date_fin  ");
        ...
        $req =$this->db->prepare('INSERT INTO `client_indiv`(`nom`, `tel`, `mail`) VALUES (:nom,:tel,:mail)');
        $req->execute(array(
            'nom' => $nomClient,
            'tel' => $telClient,
            'mail' => $mailClient ));
        ...
        $randomId = uniqid();
        $requete = $this->db->prepare('INSERT INTO vente_hotel VALUES ( :id,:idBrave, :id_user,:date,:id_client,:passager , :phone,:hotelId ,:fournisseurId ,:entree,
        :sortie,:arrangement,:achat,:vente, :etat_client, :etat_fournisseur, :etat_dossier, :remarque, :id_client_indiv , :uniqueId )');
        $requete ->execute(array('id'=>'','idBrave'=>0,'id_user'=>'1','date'=>$datejour,'id_client'=>'135','passager'=>$nomClient , 'phone'=>$telClient,
    ...
    $donnees = $this->db->query("SELECT * FROM chambre_hotel WHERE id = ".$d);
    ...
    public function getReservations(){
		...
		$reservations = $this->db->query("SELECT * FROM vente_hotel ORDER BY id DESC");
